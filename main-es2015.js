...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        imports: [
            ...
            angular4_paystack__WEBPACK_IMPORTED_MODULE_3__["Angular4PaystackModule"].forRoot('pk_test_c5bc80647b60c1bf05f3f6fdac32a99f82b598ce'),
        ],
...
let HomeComponent = class HomeComponent {
    ...
    onSubmit() {
        if (this.addressForm.get('biz').value == 'Fashion') {
            this.text =
                `${this.addressForm.get('NOC').value} is a ${this.addressForm.get('biz').value} company.`
                    + ` with more than ${this.addressForm.get('expr').value} years of experience`
                    + ` Our experienced workforce of ${this.addressForm.get('biz').value} experts are ready at your beck and  call.`
                    + ` We're located in the ever bubling city of ${this.addressForm.get('loc').value}, which places us at the center of the ${this.addressForm.get('biz').value} business`;
        }
        else if (this.addressForm.get('biz').value == 'Branding') {
            this.text =
                `At ${this.addressForm.get('NOC').value}, our aim is to provide your business with
     a unique face your propective customers can recognise
      `
                    + `. With more than ${this.addressForm.get('expr').value} years ${this.addressForm.get('biz').value}  experience`
                    + ` Our experienced workforce of ${this.addressForm.get('biz').value} experts are ready at your beck and  call.`
                    + ` We're located in the ever bubling city of ${this.addressForm.get('loc').value}, which places us at the center of the ${this.addressForm.get('biz').value} business`;
        }
            ...
            this.text =
                `${this.addressForm.get('NOC').value} is a ${this.addressForm.get('biz').value} company.`
                    + ` with more than ${this.addressForm.get('expr').value} years worth of experience, be rest assured that the maintenance of your telecomunication systems are in the right hands`
                    + ` Our experienced workforce of ${this.addressForm.get('biz').value} experts are ready at your beck and  call.`
                    + ` We're located in the ever bubling city of ${this.addressForm.get('loc').value}, which places us at the center of the ${this.addressForm.get('biz').value} business`;
        }
    }
...
module.exports = __webpack_require__(/*! C:\angular\textGen\src\main.ts */"./src/main.ts");
